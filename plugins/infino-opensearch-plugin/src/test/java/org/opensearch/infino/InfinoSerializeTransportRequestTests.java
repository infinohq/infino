...
public class InfinoSerializeTransportRequestTests extends OpenSearchTestCase {
    ...
    public void testSearchRequestParsing() throws IOException {
    ...
    public void testIndexRequestParsing() throws IOException {
        ...
        assertEquals("http://test-host:3000/test-index/append_log", infinoSerializeTransportRequest.getFinalUrl());
    }

    public void testUnsupportedTransportRequest() {
        TransportRequest unsupportedRequest = mock(TransportRequest.class);
        assertThrows(IllegalArgumentException.class, () -> new InfinoSerializeTransportRequest(unsupportedRequest));
    }
    ...
    public void testMetricsSearchEndpoint() throws IOException {
        SearchRequest mockSearchRequest = mock(SearchRequest.class);
        when(mockSearchRequest.indices()).thenReturn(new String[] { "metrics-index" });
    ...
    // public void testSummarizeEndpoint() throws IOException {
    // SearchRequest mockSearchRequest = mock(SearchRequest.class);
    // when(mockSearchRequest.indices()).thenReturn(new String[] { "test-index" });
    ...
    // mockSearchRequest);
    // assertEquals("test-index", infinoSerializeTransportRequest.getIndexName());
    // assertEquals(InfinoSerializeTransportRequest.InfinoOperation.SUMMARIZE,
    // infinoSerializeTransportRequest.getOperation());
    // assertTrue(infinoSerializeTransportRequest.getFinalUrl().contains("/summarize?"));
    // }
